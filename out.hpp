...
// Autogenerated at 2021-06-02 23:53:52.372143 by C:\Users\Jim\Desktop\wip\visitor_generator.py.
...
template <typename Visitor, typename T,
          std::enable_if_t<std::is_same_v<test_types::Empty, std::remove_const_t<T>>, bool> = true>
...
template <typename Visitor, typename T,
          std::enable_if_t<std::is_same_v<test_types::Basics, std::remove_const_t<T>>, bool> = true>
constexpr void visit([[maybe_unused]] T& toVisit, [[maybe_unused]] Visitor&& visitor) {
    visitor("b", toVisit.b);
    visitor("i", toVisit.i);
    visitor("d", toVisit.d);
...
template <typename Visitor, typename T,
          std::enable_if_t<std::is_same_v<test_types::Wrapper, std::remove_const_t<T>>, bool> = true>
constexpr void visit([[maybe_unused]] T& toVisit, [[maybe_unused]] Visitor&& visitor) {
    visitor("i", toVisit.i);
    visitor("d", toVisit.d);
    visitor("b", toVisit.b);
